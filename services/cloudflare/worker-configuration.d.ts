/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --strict-vars=false --env-interface=CloudflareBindings` (hash: c54e88eafbaf0462188befcd99d0d7d3)
...
interface __BaseEnv_CloudflareBindings {
	...
	INBOX: DurableObjectNamespace<import("./src/index").InboxDurableObject>;
	GROUP_OUTBOX: DurableObjectNamespace<import("./src/index").GroupOutboxDurableObject>;
	DEVICE_REGISTRY: DurableObjectNamespace<import("./src/index").DeviceRegistryDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "InboxDurableObject" | "GroupOutboxDurableObject" | "DeviceRegistryDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "RUNTIME_ID" | "OWNER_USER_ID" | "OWNER_USER_PUBLIC_KEY" | "DEPLOYMENT_REGION" | "MAX_INLINE_BYTES" | "RETENTION_DAYS" | "RATE_LIMIT_PER_MINUTE" | "RATE_LIMIT_PER_HOUR" | "MESSAGE_REQUEST_MAX_BODY_BYTES" | "MESSAGE_REQUEST_MAX_PER_SENDER" | "MESSAGE_REQUEST_MAX_SENDERS" | "MESSAGE_REQUEST_MAX_TOTAL_BYTES" | "MESSAGE_REQUEST_TTL_SECONDS" | "MESSAGE_REQUEST_RATE_LIMIT_MINUTE" | "MESSAGE_REQUEST_RATE_LIMIT_HOUR" | "ATTACHMENT_DOWNLOAD_GRANT_TTL_DAYS">> {}
}
