/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --strict-vars=false --env-interface=CloudflareBindings` (hash: f67235bfaba063dcbb076348a7490a6f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "RUNTIME_ID" | "OWNER_USER_ID" | "OWNER_USER_PUBLIC_KEY" | "WORKER_BUILD_ID" | "DEPLOYMENT_REGION" | "MAX_INLINE_BYTES" | "RETENTION_DAYS" | "RATE_LIMIT_PER_MINUTE" | "RATE_LIMIT_PER_HOUR" | "MESSAGE_REQUEST_MAX_BODY_BYTES" | "MESSAGE_REQUEST_MAX_PER_SENDER" | "MESSAGE_REQUEST_MAX_SENDERS" | "MESSAGE_REQUEST_MAX_TOTAL_BYTES" | "MESSAGE_REQUEST_TTL_SECONDS" | "MESSAGE_REQUEST_RATE_LIMIT_MINUTE" | "MESSAGE_REQUEST_RATE_LIMIT_HOUR">> {}
}
